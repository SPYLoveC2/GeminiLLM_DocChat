...
from artifacts import get_retriever, get_available_embedding, print_history, get_gemini_model
...
if "chat_session" not in st.session_state:
    ...
    st.session_state.chat_session = get_gemini_model(os.getenv('GOOGLE_API_KEY'))
